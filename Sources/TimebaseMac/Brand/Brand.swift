...
/// Tokens duplicated per target by design; the anchors here are identical to
/// iOS by construction, sizes re-tuned for the Mac.
enum Brand {

    // MARK: - Type ramp

    /// Crimson Text — wordmark, city names in detail, dialog headers.
    static func serif(_ size: CGFloat) -> Font {
        .custom("CrimsonText-SemiBold", size: size)
    }

    /// Departure Mono — deltas, countdowns, technical labels.
    ...
    /// Time-of-day emoji eyebrow for a city, chosen from its local hour.
    ...
    /// Time-of-day greeting for the menubar / about — mirrors the iOS easter
    /// egg greetings.
